...
!deepspeed --include localhost:0,1  my_own_finetune.py  \
...
def parse_args():
    parser = argparse.ArgumentParser(description='ChatGLM3-3B Function Call QLoRA')
...
def train(global_args):
    ...
    hf_train_args.optim="paged_adamw_32bit" #"paged_adamw_8bit"  # qlora better use "paged_adamw_32bit or 8bit " full-parameter sft use adamw_hf
    ...
    logger.info("loading train_data/eval_data...")
    ...
    train_data = train_data_all[:-200]
    eval_data =  train_data_all[-200:]
